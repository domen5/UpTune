        ...
        for (Tag tag : arrayList) {
            switch (tag.getText()) {
                ...
                case "Newest":
                    ...
                    break;
             /*    case "Album":
                    Collections.sort(setCards, HistoryElement.albumComparator);
                    break;
               case "Used":
                    Collections.sort(setCards, HistoryElement.usedComparator);
                    break;
                case "Song":
                    Collections.sort(setCards.songComparator);
                    break;
                */
                case "Price":
